            ...
            <div className="flex justify-center items-center w-full py-20">
                <div className="flex flex-wrap  w-full gap-30 p-12 ">
                    ...
                    <div className="flex-1 flex flex-col bg-gray-700/50 rounded-2xl px-6 py-2 shadow-xl shadow-blue-400/20 ">
                        <h2 className="text-2xl font-semibold text-left">
                            ...
                            <span className="text-green-400 text-4xl font-bold block mt-2">$1 250,98</span>
                        </h2>
                        ...
                        <div className="w-full h-[300px] mt-6 bg-[url('/rectangle.png')] bg-center bg-contain bg-no-repeat"></div>
                            ...
                            >What does income depend on?</h2>
                            <ul className="mt-16 space-y-4  text-xl text-gray-300">
                                <li>- The reward is calculated depending on the number of coins invested in the masternode.</li>
                                <li>- The more you invest in BCE, the more rewards you will receive</li>
                            </ul>
                            </div>
                    </div>
                </div> 
                ...
                <div className="flex flex-wrap  w-full gap-30 p-12 ">
                            <div className="flex flex-1 flex-col text-4xl py-3 gap-y-10">
                                ...
                                <span className="text-2xl font-exo">The easiest way is to join through a pool on the BCE2um.com exchange.</span>
                            </div>
                            <div className="flex-1">
                                <ul className="flex flex-col gap-y-5 text-3xl [&_span]:text-green-500 [&_span]:text-xl">
                                <li><span>01 </span>Register on the exchange</li>
                                    <Link href="#" className="w-fit ml-[35px] bg-linear-30 from-[#2E727A] to-[#2E7A] py-3 px-10 rounded-2xl transform hover:bg-linear-30 hover:from-[#2E7A] hover:to-[#2E727A] duration-300 transition-colors"> 
                                    REGISTER
                                    </Link>     
                               <li><span>02 </span>Buy BCE coins</li>
                                <li><span>03 </span>Send coins to masternode</li>
                                <li><span>04 </span>Wait for the reward</li>
                                </ul>
                            </div>
                        </div>
                    </div>             
