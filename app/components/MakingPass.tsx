    ...
    return (
        <section className="bg-[url(/bgMakingPassive.png)] bg-no-repeat bg-right-top bg-cover xl:bg-contain w-full min-h-min pb-20 mb-5 mt-30 pt-5 px-5">
            <div className="max-w-screen-2xl mx-auto w-full">
                ...
                <div 
                    ref={sliderRef} 
                    className="flex gap-3 mt-20 mb-20 py-5 items-center overflow-hidden overflow-x-auto scroll-smooth snap-x snap-mandatory cursor-grab active:cursor-grabbing md:justify-center">
