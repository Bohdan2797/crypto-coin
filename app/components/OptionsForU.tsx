        ...
        <section className="w-full max-w-screen-2xl mx-auto min-h-screen">
            ...
            <div className="flex mt-10 gap-3">
                ...
                <div className="flex py-5">
                    <span className="text-green-500 font-bold text-sm pl-5 ">01</span> <span className="text-sm font-bold">/ 02</span>
                </div>
...
>
<div className="flex py-5">
                    <span className="text-green-500 font-bold text-sm pl-5 ">02</span> <span className="text-sm font-bold">/ 02</span>
                </div>
  ...
  >
    Blockchain BaseCore assumes rewards for block validation to two participants in the network
  </h2>
  <div className="w-full flex flex-col items-end mt-4">
    <div className="flex flex-col items-start gap-y-2"> {/* Используем flex-col для вертикального расположения */}
  ...
  <div className="w-full border-2 border-green-500 rounded-2xl mt-20 mb-10 flex gap-20 px-10 pt-6 pb-3">
    <div className="text-xl font-semibold">
        ...
        >Stakers and masternodes receive rewards for block validation</h2>
    </div>
    <div className="w-full">
        {/* Первый блок */}
        <div className="border-b-2 border-green-500 flex justify-between items-center pt-3 pb-5 gap-30">
            <span className="text-xl font-bold text-nowrap text-green-500">0.5 BCE</span>
            <span className="flex-1 pl-5">Is generated every minute, with 0.005 BCE allocated to stakers</span>
        </div>
        {/* Второй блок */}
        <div className="flex justify-between items-center py-5 gap-30">
            <span className="text-xl font-bold text-nowrap text-green-500">1:99 ratio</span>
            <span className="flex-1 ">Division with 0.495 BCE allocated to masternodes</span>
        </div>
    </div>
</div>
</div>
